_: {
  services.skhd = {
    ...
    config = ''
      ...
      # Resize windows
      # ctrl + alt + shift + cmd - minus : yabai -m window --resize left:-50:0 || yabai -m window --resize right:-50:0
      # ctrl + alt + shift + cmd - equal : yabai -m window --resize right:50:0 || yabai -m window --resize left:50:0
