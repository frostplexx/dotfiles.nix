    ...
    services = {
      ...
      in {
        ...
        extraConfig = ''
          ...
          yabai -m rule --add app="^Finder$" manage=tab
          yabai -m rule --add app="^Ghostty$" manage=tab
          # Ghostty quick terminal should float above all other windows and be sticky, but not steal focus when opened
          yabai -m rule --add app="^Ghostty$" subrole="AXFloatingWindow" manage=off layer=above sticky=on
