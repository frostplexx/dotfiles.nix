      ...
      config =
        ...
        */
        ''
          ...
          ctrl + alt + cmd - 1 : open -a Zen\ Browser\ \(Beta\)
          ctrl + alt + cmd - 2 : open -a Ghostty
          ctrl + alt + cmd - 3 : open -a Obsidian
          ctrl + alt + cmd - 4 : open -a Vesktop
          ctrl + alt + cmd - 5 : open -a Spotify
          ...
          # ctrl + alt + shift + cmd - 0 : yabai -m window --space 10 && yabai -m space --focus 10
