    ...
    programs = lib.mkIf pkgs.stdenv.isLinux {
      plasma = {
        ...
        configFile = {
          ...
          kactivitymanagerdrc = {
            activities.c8fdbd68-9043-4ff9-aa47-6e03e576a621 = "Default";
            main.currentActivity = "c8fdbd68-9043-4ff9-aa47-6e03e576a621";
          };
          katerc = {
            General = {
              "Days Meta Infos" = 30;
          ...
          kwalletrc = {
            Wallet."Default Wallet" = "Default keyring";
            Wallet."First Use" = false;
          };
          kwinrc = {
            Desktops = {
              Id_1 = "b4217e3c-538c-4358-9544-4d755f641f08";
              Id_2 = "bd19410d-1489-444f-b96a-7476f17e422f";
              Id_3 = "4eaeffe0-040c-4ca6-b336-591c484704ff";
              Id_4 = "d3810d91-c857-4b25-93eb-ef16a4d970f3";
              Id_5 = "ed4d5f96-5f09-42f5-ae0c-08dca270cd79";
              Id_6 = "abaf705b-b8a8-437b-a0c4-36b8a71d02af";
              "Number[$i]" = 6;
              Rows = 1;
            };
            ...
            Tiling.padding = 4;
            "Tiling/4eaeffe0-040c-4ca6-b336-591c484704ff/497954ef-e222-4657-9fc4-c2d7c3b88aff".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
