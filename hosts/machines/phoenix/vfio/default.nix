  ...
  environment.etc = {
    ...
    "libvirt/hooks/qemu.d/win10/prepare/begin/start.sh" = {
      text = ''
        ...
        # Debugging
        # exec 19>/home/daniel/Desktop/startlogfile
        # BASH_XTRACEFD=19
        # set -x
        ...
        # Logout
        source "/home/daniel/Desktop/Sync/Files/Tools/logout.sh"
    ...
    "libvirt/hooks/qemu.d/win10/release/end/stop.sh" = {
      text = ''
        ...
        # Debugging
        # exec 19>/home/daniel/Desktop/stoplogfile
        # BASH_XTRACEFD=19
        # set -x
    ...
    "libvirt/vgabios/patched.rom".source = ./patched_vbios.rom;
  };
}
